...
// TODO(dantup): Tests for
// - invalid code?
// - Review any remaining unmapped HighlightRegionTypes
...
class SemanticTokensTest extends AbstractLspAnalysisServerTest {
  ...
  Future<void> test_class() async {
    ...
    final expected = [
      _Token(
        ...
        // TODO(dantup): Check why these aren't marked as documentation comments
  ...
  Future<void> test_class_fields() async {
    ...
    final expected = [
      ...
      _Token('myField', SemanticTokenTypes.member,
      ...
      _Token('String', SemanticTokenTypes.class_),
      _Token('myStaticField', SemanticTokenTypes.member,
  ...
  Future<void> test_class_method() async {
    ...
    final expected = [
      ...
      // TODO(dantup): Improve handling of annotations so we produce a single
      // token for the whole annotation?
      ...
      _Token('myMethod', SemanticTokenTypes.member,
          [SemanticTokenModifiers.declaration]),
      _Token('/// static method docs', SemanticTokenTypes.comment),
      _Token('static', SemanticTokenTypes.keyword),
      _Token('void', SemanticTokenTypes.keyword),
      _Token('myStaticMethod', SemanticTokenTypes.member,
          [SemanticTokenModifiers.declaration, SemanticTokenModifiers.static]),
